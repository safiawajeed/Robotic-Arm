...
public class AXIS2BTOU : MonoBehaviour
{
    //private string getURL = "https://blynk.cloud/external/api/get?token=dmgTbJlV-BVjWDePZYVhIzEIyA5YZWJf&dataStreamId=2&value=";
